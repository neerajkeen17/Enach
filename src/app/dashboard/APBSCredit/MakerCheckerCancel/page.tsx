...
const MakerCheckerCancel = () => {
      ...
      try {
        ...
        if (batchId) {
          const response = await axios.get<RecordData[]>(
            `http://localhost:8080/http://localhost:8082/api/v1/apb/pending/records?batchId=${batchId}`
          );
  ...
  return (
    <div className="container mx-auto p-4 bg-white">
      <h1 className="text-2xl font-bold">Maker Checker Cancel</h1>
      <div className="bg-white shadow-md rounded-md p-4">
        <h2 className="bg-gray-100 text-lg font-semibold">APBS Maker Checker Cancel</h2>
...
export default MakerCheckerCancel;