...
//       const fileNames = Array.from(new Set(response.data.map(batchId => batchId.split('-')[4])));
//       setBatchIds(fileNames);
//     } catch (error) {
...
//                 <label htmlFor="batchid" className="block font-semibold">Batch Name:</label>
//                 <select
