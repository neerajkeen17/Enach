...
//     try{
//       const reponse = await.axios.post("http://10.15.15.205:9718/esb/NACH/usersec/authenticate",
//       {
//       UserName:userId,
//       Password:password,
//       }
...
//       if(reponse.data.returnCode==="0"){
//         router.push("/dashboard");
//       }else{
//         setShowInvalidMessage(true);
//         setUserIdError("Invalid user ID or password")
//       }
//     } catch (error) {
//       console.error(error);
//       setShowInvalidMessage(true);
//       setUserIdError("An error occurred. Please try again later")
//     }
//   };
...
//           <button className='bg-[#aca7a7] mx-2 w-20 h-10 rounded-lg' onClick={handleCancel}>Cancel</button>
//         </div>
//       </div>
//     </main>
//   );
